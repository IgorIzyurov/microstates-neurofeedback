...
info_noise = lsl_streaminfo(lib,'EEG-notICA','EEG-notICA',Qchan,Srate,'cf_float32','sdfwerr32432');

disp('Opening an outlet...');
outlet_ICA = lsl_outlet(info_ICA);
outlet_noise = lsl_outlet(info_noise);
...
% save('D:\EEG-NF_Data\PILOT\PLT_PILOT_KpPfM\RS\RS_eo_ica.mat','Data_ica');
% save('D:\EEG-NF_Data\PILOT\PLT_PILOT_KpPfM\RS\RS_eo_raw.mat','Data_raw');
