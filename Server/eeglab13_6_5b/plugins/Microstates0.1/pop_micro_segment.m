...
switch settings.algorithm
    case 'Modified K-means'
        ...
        [OUTEEG.microstate.scalp_maps, OUTEEG.microstate.labels, ...
            OUTEEG.microstate.Res] = modkmeans(EEG.microstate.data, K_range, opts);
...
[KL, W, CV, GEV] = calc_fitmeas(EEG.microstate.data, OUTEEG.microstate.Res.A_all, ...
...
OUTEEG = sort_microstates(EEG.microstate.data,OUTEEG,sort_names_opt);
