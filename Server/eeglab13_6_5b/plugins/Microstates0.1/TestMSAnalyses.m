...
Group1Dir = uigetdir([],'Path to the data of group 1 (Vision Analyzer data)');
Group2Dir = uigetdir([],'Path to the data of group 2 (Vision Analyzer data)');
...
for f = 1:numel(FileNamesGroup1)
    ...
    setname = strrep(FileNamesGroup1{f},'.vhdr',''); % Set a useful name of the dataset
